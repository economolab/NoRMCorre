...
% Define your vectors
[extended_grid,i,j,k] = getExtendedGrid(xx_s,xx_f,yy_s,yy_f,zz_s,zz_f,overlap,sz);
% Compute extended grids

I = arrayfun(@(ii, jj,kk) X(extended_grid(1,ii,jj):extended_grid(2,ii,jj), extended_grid(3,ii,jj):extended_grid(4,ii,jj), extended_grid(5,ii,jj):extended_grid(6,ii,jj), :), i, j,k, 'UniformOutput', false);